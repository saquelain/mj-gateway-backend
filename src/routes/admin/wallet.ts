...
adminWalletRouter.get('/:clientId/wallet', authenticateAdmin, async (req, res) => {
...
// Paginated transaction history for a client's wallet
adminWalletRouter.get('/:clientId/wallet/transactions', authenticateAdmin, async (req, res) => {
  const clientId = Number(req.params.clientId);
